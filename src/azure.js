...
console.log(
	`This Javascript application will search images for ${searchTerm} then print the URL to first result`
)
...
sendQuery()
	.then((imageResults) => {
		if (imageResults == null) {
			...
			console.log(
				`Total number of images returned: ${imageResults.value.length}`
			)
